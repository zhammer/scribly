...
def test_verification_email() -> None:
    ...
    base_url = "http://scribly.herokuapp.com"
    token = "verification_token"

    # when we build an email for the user
    email = build_email_verification_email(user, base_url, token)
...
<body style="color:#191919; font-family:monospace; font-size:16px">
  ...
  <a class="button" href="http://scribly.herokuapp.com/email-verification?token=verification_token" style="background:transparent; border:solid 1px; cursor:pointer; font-size:11px; padding:1em; color:#191919; text-decoration:none">verify your email</a>
</body>
