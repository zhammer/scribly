...
def test_verification_email() -> None:
    ...
    expected_body_regex = re.compile(
        (
            ...
            r"<a class=\"button\".*"
            r"href=\"https://scribly.glitch.me/email-verification\?token=verification_token\".*>"
    ...
    def test_sends_notifications_write(self) -> None:
        ...
        expected_zach_email_regex = re.compile(
            (
                ...
                r"<head><style.*>.*</style></head>\s*"
                r"<body.*>\s*"
                r"<p>\s*<a href=\"https://scribly.glitch.me/stories/1\">go to your story</a>\s*</p>\s*"
                r"<p>\s*"
    ...
    def test_builds_added_to_story_emails(self) -> None:
        ...
        expected_gabe_email_regex = re.compile(
            (
                ...
                r"<body.*>\s*"
                r"<p>\s*"
                r"<span>zach started the story <a\s*href=\"https://scribly.glitch.me/stories/1\">Phaedrus</a>!\s*</span>\s*"
                r"<span> it's your turn</span>\s*"
                r"</p>\s*"
                r"<div>\s*"
                r"<h3.*>cowriters:</h3>\s*"
